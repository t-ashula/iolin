...
(function( I ){
  ...
  _DM.prototype.ToOperaLinkXml = function(){
    return toSyncItems_.aggregate(
      "", function( x, ele ){ return x + ele.ToOperaLinkXml(); } );
  };

  _DM.prototype.FromOperaLinkXml = function( dom ) {
    var dm = this;
    for ( var j = 0, tag; tag = dm.ownElements_[ j ]; ++j ){
      var eles = dom.getElementsByTagName( tag );
  ...
  _DM.prototype.Add = function( c ){
    var dm = this;
    var item = new dm.dw_( c, dm.dw_.SYNC_DATA_STATUS_ADD );
    if ( dm.addItem( item ) ) { dm.addSyncItem( item ); }
    return dm.innerItems_.length;
  };

  _DM.prototype.addItem = function( d ){
    var dm = this;
    if ( dm.innerItems_.some( function( e ){ return e.IsSameContent( d ); } ) ) { return false; }
  ...
  _DM.prototype.Mod = function( c ) {
    var dm = this;
    var item = new dm.dw_( c, dm.dw_.SYNC_DATA_STATUS_MOD );
    dm.modItem( item ) ;
    dm.modSyncItem( item );
    return dm.innerItems_.length;
  };
  ...
  _DM.prototype.modItem = function( d ) {
    var dm = this;
    var idx = innerItems_.indexOfPred( function( e ){ return e.IsSameContent( d ); } );
  ...
  _DM.prototype.modSyncItem = function( d ) {
    var dm = this;
    var idx =  dm.toSyncItems_.indexOfPred( function( e ){ return e.IsSameContent( d ); } );
    if ( idx < 0 ){ return false; }
    if ( dm.toSyncItems_[ idx ].SyncState === dm.dw_.SYNC_DATA_STATUS_DEL ){ return false; }
  ...
  _DM.prototype.Del = function( c ) {
    var dm = this;
    var item = new dm.dw_( c, dm.dw_.SYNC_DATA_STATUS_DEL );
    if ( dm.delItem( item ) ) { dm.delSyncItem( item ); }
    return dm.innerItems_.length;
  };
  
  _DM.prototype.delItem = function( d ) {
    var dm = this;
    var idx = dm.innerItems_.indexOfPred( function( e ){ return e.IsSameContent( d ); } );
    if ( idx < 0 ){ return false; }
